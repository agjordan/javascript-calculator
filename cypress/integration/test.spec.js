...
it ('multiplies numbers (11×33= 363)', () => {
    cy.visit("http://127.0.0.1:5500/calculatorB/index.html")
    cy.get('#num_1').click()
    cy.get('#num_1').click()
...
it ('divides numbers (10÷12= 0.833)', () => {
    cy.visit("http://127.0.0.1:5500/calculatorB/index.html")
    cy.get('#num_1').click()
    cy.get('#num_0').click()
...
it ('can add decimals (10+1.2 = 11.2)', () => {
    cy.visit("http://127.0.0.1:5500/calculatorB/index.html")
    cy.get('#num_1').click()
    cy.get('#num_0').click()
    cy.get('#sym_plus').click()
...
it ('displays message when input/output too long', () => {
    cy.visit("http://127.0.0.1:5500/calculatorB/index.html")
    cy.get('#num_1').click()
    cy.get('#num_0').click()
    cy.get('#num_0').click()
